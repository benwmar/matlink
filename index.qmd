---
title: "CDC / Jphns Hopkins guide to getting started with OMOP for MATLINK"
...
MATLINK is a public health surveillance program designed and developed by the Centers for Disease Control (CDC) to capture real world data (RWD) for tracking....
...
01 -- Cohort Creation\...\...\...\...\...\...\...\...\... (Filename: [01_MATLINK_Cohort.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/01_MATLINK_Cohort.sql))

02 -- Generate MATLINK Tables\...\...\...\... (Filename: [02_MATLINK_All_Tables.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/02_MATLINK_All_Tables.sql))

03 -- Deidentify Rare Conditions.......... (Filename: [03_MATLINK_replace_rare_conditions_with_parents.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/03_MATLINK_replace_rare_conditions_with_parents.sql))

04 -- Generate OMOP Tables.............. (Filename: [04_DE_ID_CDM_Table_ddl.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/04_DE_ID_CDM_Table_ddl.sql))

05 -- Remove Identifiers...................... (Filename: [05_DE_ID_script.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/05_DE_ID_script.sql))

06 -- Run Data Quality Checks............. (Filename: [06_DE_ID_Quality_Checks.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/06_DE_ID_Quality_Checks.sql))

07-A -- Profile Conditions\...\...\...\...\...\...\... (Filename: [07_A_condition_profile.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/07_A_condition_profile.sql))

07-B -- Profile Measurements............. (Filename: [07_B_measurement_profile.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/07_B_measurement_profile.sql))

07-C -- Profile Drug Exposure.............. (Filename: [07_C_drug_exposure_profile.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/07_C_drug_exposure_profile.sql))

07-D -- Profile Unmapped Drugs\...\...\... (Filename: [07_D_review_unmapped_drugs.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/07_D_review_unmapped_drugs.sql))

07-D -- Profile Devices......................... (Filename: [07_E_device_profile.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/07_E_device_profile.sql))

**OMOP Cohort Creation and Deidentification Process:**

#### [01 -- Cohort Creation Script]{.underline}

**Filename**: [01_MATLINK_Cohort.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/01_MATLINK_Cohort.sql)

**Purpose**: This script creates a cohort of patients for the MATLINK registry. The patient list is saved in the cohort table, along with other useful data elements.
...
#### [02 -- MATLINK Tables Script]{.underline}

**Filename**: [02_MATLINK_All_Tables.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/02_MATLINK_All_Tables.sql)

**Purpose**: This script takes your OMOP dataset and generates a copy of key tables that have been filtered down to only include people and records related to the MATLINK registry.

**Description**: Creates MATLINK tables from the generated MATLINK cohort.

**Dependencies**: This script depends on MATLINK_Cohort.sql, and must be run after that script completes
...
**Filename**: [03_MATLINK_replace_rare_conditions_with_parents.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/03_MATLINK_replace_rare_conditions_with_parents.sql)

**Purpose**: Replace conditions occurring 10 or less times in the dataset with parent concepts that have at least 10 counts

**Dependencies**: This script requires the cohort table built from 01_MATLINK_Cohort.sql, and the data loaded into the Condition Occurrence table built from 02_MATLINK_All_Tables.sql.
...
**Filename**: [04_DE_ID_CDM_Table_ddl.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/04_DE_ID_CDM_Table_ddl.sql)

**Purpose**: Generate the necessary tables for the de-identified version of the MATLINK Cohort
...
**Filename**: [05_DE_ID_script.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/05_DE_ID_script.sql)
...
**Dependencies**: This script requires the cohort table built from 01_MATLINK_Cohort.sql, and the data loaded into all tables built from 02_MATLINK_All_Tables.sql, rare conditions replace from 03_MATLINK_replace_rare_conditions_with_parents.sql, and the de-identified OMOP CDM tables generated from 04_DE_ID_CDM_Table_ddl.sql.
...
**Filename**: [06_DE_ID_Quality_Checks.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/06_DE_ID_Quality_Checks.sql)
...
01_MATLINK_Cohort.sql,

02_MATLINK_All_Tables.sql,

03_MATLINK_replace_rare_conditions_with_parents.sql,
...
**Filename**: [07_A_condition_profile.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/07_A_condition_profile.sql)
...
**Filename**: [07_B_measurement_profile.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/07_B_measurement_profile.sql)
...
**Filename**: [07_C_drug_exposure_profile.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/07_C_drug_exposure_profile.sql)
...
**Filename**: [07_D_review_unmapped_drugs.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/07_D_review_unmapped_drugs.sql)

**Purpose**: Generate a profile of drugs that are not mapped to drug_concept_ids in the final cohort.

**Description**: This file filters drugs that were unsuccessfully mapped to a drug_concept_id when running the 02_MATLINK_All_Tables.sql script. Drug source values for which the drug_concept_id is "0" and have at least 20 instances in the final cohort are aggregated for manual review.

\*\* Drug source values can contain PHI. Please review the output for PHI before sharing.

07-E -- Device Profile

**Filename**: [07_E_device_profile.sql](https://github.com/OHDSI/PHReGWG/blob/main/Cohort%20curation%20scripts/07_E_device_profile.sql)
...
## MATLINK Profile Scripts -- Output & Interpretation
